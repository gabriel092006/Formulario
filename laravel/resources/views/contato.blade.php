...
<head>
    ...
    <title>Contato - Venda de Motos</title>
    ...
    <main>
        <section class="contact">
            ...
            <form action="enviar.html" method="post">
                ...
                <input required="" autocomplete="username" type="text" name="username" id="username">

                <label for="phone">Telefone:</label>
                <input required="" autocomplete="tel" type="text" name="tel" id="tel">

                <label for="address">Endereço:</label>
                <input required="" autocomplete="current-password" type="text" >
